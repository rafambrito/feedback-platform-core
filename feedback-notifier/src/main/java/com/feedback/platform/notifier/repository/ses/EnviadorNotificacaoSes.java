...
@ApplicationScoped
public class EnviadorNotificacaoSes implements EnviadorNotificacao {

        private static final Logger LOGGER = LoggerFactory.getLogger(EnviadorNotificacaoSes.class);
        ...
        public EnviadorNotificacaoSes(SesClient sesClient, String fromEmail) {
                this(sesClient, fromEmail, "");
        }

        public EnviadorNotificacaoSes(SesClient sesClient, String fromEmail, String toEmailOverride) {
