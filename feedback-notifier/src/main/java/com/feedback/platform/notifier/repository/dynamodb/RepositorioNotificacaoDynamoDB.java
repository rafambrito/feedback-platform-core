...
@ApplicationScoped
public class RepositorioNotificacaoDynamoDB implements RepositorioNotificacao {

    private static final Logger LOG = Logger.getLogger(RepositorioNotificacaoDynamoDB.class);
