...
@ApplicationScoped
public class ConsumidorNotificacaoFeedback {

    private static final Logger LOG = Logger.getLogger(ConsumidorNotificacaoFeedback.class);
    ...
    @Inject
    public ConsumidorNotificacaoFeedback(
            SqsClient sqsClient,
    ...
    void consumirFila() {
        String queueUrl = resolverUrlFila();
    ...
    public void processarMensagem(String messageBody) {
        ...
        try {
            UrgencyNotification feedbackEventDTO = parsearEventoFeedback(messageBody);
    ...
    private String resolverUrlFila() {
    ...
    private UrgencyNotification parsearEventoFeedback(String messageBody) throws JsonProcessingException {
