...
@ApplicationScoped
public class PublicadorEventoEventBridge implements PublicadorEvento {

    private static final Logger LOG = Logger.getLogger(PublicadorEventoEventBridge.class);
    ...
    @Inject
    public PublicadorEventoEventBridge(EventBridgeClient eventBridgeClient, ObjectMapper objectMapper) {
