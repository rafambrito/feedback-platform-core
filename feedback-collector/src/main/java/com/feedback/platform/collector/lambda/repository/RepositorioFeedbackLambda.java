...
public class RepositorioFeedbackLambda {

    public record FeedbackSalvo(
            String id,
            String cursoId,
            String alunoId,
            String professorId,
    ...
    public RepositorioFeedbackLambda() {
        this.tableName = System.getenv().getOrDefault("AWS_DYNAMODB_TABLE", "FeedbackTable");
        this.dynamoDbClient = construirCliente();
    }

    public FeedbackSalvo salvar(FeedbackRequestDTO request, String requestId) {
    ...
    public Map<String, AttributeValue> buscarPorId(String id) {
    ...
    private DynamoDbClient construirCliente() {
