package com.feedback.platform.collector.repository.dynamodb;
...
@ApplicationScoped
public class RepositorioFeedbackDynamoDB implements RepositorioFeedback {
    ...
    @Inject
    public RepositorioFeedbackDynamoDB(DynamoDbClient dynamoDbClient) {
